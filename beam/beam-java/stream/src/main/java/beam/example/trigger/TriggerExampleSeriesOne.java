...
public class TriggerExampleSeriesOne {
  ...
  static final List<OutputMessage> randomOutputMessageInsideWindow = Arrays.asList(
    ...
    new OutputMessage("6", 10, nextWindow.plus(3 * MINUTES)),
    new OutputMessage("6", 10, nextWindow.plus(3 * MINUTES)),
    new OutputMessage("6", 10, nextWindow.plus(3 * MINUTES + SECONDS)),
    new OutputMessage("6", 10, nextWindow.plus(3 * MINUTES + SECONDS)),
    new OutputMessage("6", 10, nextWindow.plus(3 * MINUTES + SECONDS)),
    new OutputMessage("6", 10, nextWindow.plus(3 * MINUTES + SECONDS)),
    new OutputMessage("6", 10, nextWindow.plus(3 * MINUTES + SECONDS)),
    new OutputMessage("6", 10, nextWindow.plus(3 * MINUTES + SECONDS)),
    new OutputMessage("6", 10, nextWindow.plus(3 * MINUTES + SECONDS)),
    new OutputMessage("6", 10, nextWindow.plus(3 * MINUTES + 2 * SECONDS)),
    new OutputMessage("6", 10, nextWindow.plus(3 * MINUTES + 2 * SECONDS)),
    new OutputMessage("6", 10, nextWindow.plus(3 * MINUTES + 2 * SECONDS)),
    new OutputMessage("6", 10, nextWindow.plus(3 * MINUTES + 3 * SECONDS)),
    new OutputMessage("6", 10, nextWindow.plus(3 * MINUTES + 3 * SECONDS)),
    new OutputMessage("6", 10, nextWindow.plus(3 * MINUTES + 3 * SECONDS)),
    new OutputMessage("6", 10, nextWindow.plus(3 * MINUTES + 10 * SECONDS)),
    ...
    new OutputMessage("6", 10, nextWindow.plus(4 * MINUTES)),
    new OutputMessage("6", 10, nextWindow.plus(4 * MINUTES)),
    new OutputMessage("6", 10, nextWindow.plus(4 * MINUTES + SECONDS)),
    new OutputMessage("6", 10, nextWindow.plus(4 * MINUTES + SECONDS)),
    new OutputMessage("6", 10, nextWindow.plus(4 * MINUTES + SECONDS)),
    new OutputMessage("6", 10, nextWindow.plus(4 * MINUTES + SECONDS)),
    new OutputMessage("6", 10, nextWindow.plus(4 * MINUTES + 2 * SECONDS)),
    new OutputMessage("6", 10, nextWindow.plus(4 * MINUTES + 3 * SECONDS)),
    new OutputMessage("6", 10, nextWindow.plus(4 * MINUTES + 4 * SECONDS)),
