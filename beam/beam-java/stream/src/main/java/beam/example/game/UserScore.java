...
import beam.example.game.utils.WriteToText;
      ...
      return gameInfo
        .apply(
          MapElements.into(
            ...
            .via((GameActionInfo gInfo) -> {
              KV<String, Integer> kv = KV.of(gInfo.getKey(field), gInfo.getScore());

              System.out.println(kv + " event time at: " + Instant.ofEpochMilli(gInfo.timestamp));
