...
public class SideInput {
  ...
  static final Logger LOG = Logger.getLogger(SideInput.class.getName());
  ...
  /**
   * Options supported by {@link SideInput}.
   *
  ...
  public interface Options extends PipelineOptions {
    ...
    @Validation.Required
    @Default.String(ExampleUtils.PROJECT_ID + ":cookbook.sideInput")
    String getOutput();
