...
//   CREATE TABLE `cookbook.filter_output` (
//     year INT OPTIONS(description="Year"),
//     month INT OPTIONS(description="Month"),
//     day INT OPTIONS(description="Day"),
//     mean_temp INT OPTIONS(description="Mean Temperature")
//   );
...
var (
	...
	output = flag.String("output", "beam-tutorial-272917:cookbook.filter_output", "Output BQ table.")
