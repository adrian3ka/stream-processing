...
var (
	...
	output = flag.String("output", "beam-tutorial-272917:cookbook.tornadoes", "BigQuery table to write to, specified as <project_id>:<dataset_id>.<table_id>. The dataset must already exist")
)
